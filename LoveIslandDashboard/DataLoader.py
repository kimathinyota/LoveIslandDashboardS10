...
def load_comments():
    comment_df = pd.read_csv('LoveIslandDashboard/Data/Comment_inc_sentiments_2023-06-09_2023-07-11.csv')
...
def load_posts():
    return pd.read_csv('LoveIslandDashboard/Data/Post_2023-06-10_2023-07-11.csv')
