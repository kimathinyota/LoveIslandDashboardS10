...
def load_comments():
    comment_df = pd.read_csv('LoveIslandDashboard/Data/Comment_inc_sentiments_2023-06-03_2023-08-11.csv')
    comment_df["date"] = pd.to_datetime(comment_df.createdDate, unit='s')
    comment_df['day'] = (comment_df["date"] - pd.to_datetime('2023-6-05')).dt.days + 1
    return comment_df

def load_posts():
    return pd.read_csv('LoveIslandDashboard/Data/Post_2023-06-03_2023-08-11.csv')
